...
class PoisonGANConfig:
    VARIANTS: ClassVar[tuple] = ("legacy", "temporal_adaptive")

    num_classes: int
    fake_class: int
    gan_variant: str = "legacy"
    ...
    @classmethod
    def for_variant(cls, gan_variant: str, **kwargs) -> "PoisonGANConfig":
